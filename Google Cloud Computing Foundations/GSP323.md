...
```
Search Dataproc > Click on cluster-b53a<br>
Vm Instance > ssh > 
```
hdfs dfs -cp gs://cloud-training/gsp323/data.txt /data.txt
```
From left pannel select jobs > Submit job<br>
Region From LAB > Cluster cluster-b53a > Job type spark<br>
